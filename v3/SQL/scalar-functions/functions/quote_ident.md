...
| Discovery | SELECT * FROM pg_catalog.pg_proc WHERE proname = 'quote_ident'; |

## Purpose

Executes the scalar function quote ident as registered in the MonkDB scalar function registry.
