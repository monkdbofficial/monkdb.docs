...
| Discovery | SELECT * FROM pg_catalog.pg_proc WHERE proname = 'object_values'; |

## Purpose

Executes the scalar function object values as registered in the MonkDB scalar function registry.

## Syntax

~~~sql
SELECT object_values({"x":1,"y":2});
~~~
