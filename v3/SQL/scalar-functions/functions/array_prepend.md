...
| Discovery | SELECT * FROM pg_catalog.pg_proc WHERE proname = 'array_prepend'; |

## Purpose

Executes the scalar function array prepend as registered in the MonkDB scalar function registry.
