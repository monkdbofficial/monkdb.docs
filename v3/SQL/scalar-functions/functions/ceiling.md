...
| Discovery | SELECT * FROM pg_catalog.pg_proc WHERE proname = 'ceiling'; |

## Purpose

Executes the scalar function ceiling as registered in the MonkDB scalar function registry.
