...
| Discovery | SELECT * FROM pg_catalog.pg_proc WHERE proname = 'make_interval'; |

## Purpose

Executes the scalar function make interval as registered in the MonkDB scalar function registry.

## Syntax

~~~sql
SELECT make_interval(0, 0, 0, 2, 3, 0, 0.5);
~~~
