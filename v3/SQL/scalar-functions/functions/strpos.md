...
| Discovery | SELECT * FROM pg_catalog.pg_proc WHERE proname = 'strpos'; |

## Purpose

Executes the scalar function strpos as registered in the MonkDB scalar function registry.

## Syntax

~~~sql
SELECT strpos('monkdb', 'db');
~~~
