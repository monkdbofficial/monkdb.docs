...
| Discovery | SELECT * FROM pg_catalog.pg_proc WHERE proname = 'extract_week'; |

## Purpose

Executes the scalar function extract week as registered in the MonkDB scalar function registry.

## Syntax

~~~sql
SELECT extract_week(current_timestamp);
~~~
