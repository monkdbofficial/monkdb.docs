...
| Discovery | SELECT * FROM pg_catalog.pg_proc WHERE proname = 'latitude'; |

## Purpose

Executes the scalar function latitude as registered in the MonkDB scalar function registry.
