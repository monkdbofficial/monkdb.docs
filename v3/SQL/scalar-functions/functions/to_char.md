...
| Discovery | SELECT * FROM pg_catalog.pg_proc WHERE proname = 'to_char'; |

## Purpose

Executes the scalar function to char as registered in the MonkDB scalar function registry.
