...
| Discovery | SELECT * FROM pg_catalog.pg_proc WHERE proname = 'lpad'; |

## Purpose

Executes the scalar function lpad as registered in the MonkDB scalar function registry.

## Syntax

~~~sql
SELECT lpad('monkdb', 10, '.');
~~~
