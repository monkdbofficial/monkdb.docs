...
| Discovery | SELECT * FROM pg_catalog.pg_proc WHERE proname = 'translate'; |

## Purpose

Executes the scalar function translate as registered in the MonkDB scalar function registry.
