...
| Discovery | SELECT * FROM pg_catalog.pg_proc WHERE proname = 'array_unique'; |

## Purpose

Executes the scalar function array unique as registered in the MonkDB scalar function registry.

## Syntax

~~~sql
SELECT array_unique([1,2,3], [2,3,4]);
~~~
