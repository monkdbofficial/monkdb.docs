...
| Discovery | SELECT * FROM pg_catalog.pg_proc WHERE proname = 'object_merge'; |

## Purpose

Executes the scalar function object merge as registered in the MonkDB scalar function registry.

## Syntax

~~~sql
SELECT object_merge({"x":1}, {"y":2});
~~~
