...
| Discovery | SELECT * FROM pg_catalog.pg_proc WHERE proname = 'intersects'; |

## Purpose

Executes the scalar function intersects as registered in the MonkDB scalar function registry.
