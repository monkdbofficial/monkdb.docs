...
| Discovery | SELECT * FROM pg_catalog.pg_proc WHERE proname = 'rpad'; |

## Purpose

Executes the scalar function rpad as registered in the MonkDB scalar function registry.

## Syntax

~~~sql
SELECT rpad('monkdb', 10, '.');
~~~
