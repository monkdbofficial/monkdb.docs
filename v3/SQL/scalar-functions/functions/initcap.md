...
| Discovery | SELECT * FROM pg_catalog.pg_proc WHERE proname = 'initcap'; |

## Purpose

Executes the scalar function initcap as registered in the MonkDB scalar function registry.
