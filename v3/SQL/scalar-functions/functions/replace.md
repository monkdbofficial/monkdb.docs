...
| Discovery | SELECT * FROM pg_catalog.pg_proc WHERE proname = 'replace'; |

## Purpose

Executes the scalar function replace as registered in the MonkDB scalar function registry.
