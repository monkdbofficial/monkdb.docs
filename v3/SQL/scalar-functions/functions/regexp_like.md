...
| Discovery | SELECT * FROM pg_catalog.pg_proc WHERE proname = 'regexp_like'; |

## Purpose

Executes the scalar function regexp like as registered in the MonkDB scalar function registry.

## Syntax

~~~sql
SELECT regexp_like('abc-123', '^[a-z]+-[0-9]+$');
~~~
