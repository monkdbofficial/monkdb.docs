...
| Discovery | SELECT * FROM pg_catalog.pg_proc WHERE proname = 'subtract'; |

## Purpose

Executes the scalar function subtract as registered in the MonkDB scalar function registry.
