...
| Discovery | SELECT * FROM pg_catalog.pg_proc WHERE proname = 'regexp_matches'; |

## Purpose

Executes the scalar function regexp matches as registered in the MonkDB scalar function registry.

## Syntax

~~~sql
SELECT regexp_matches('a1 b2 c3', '([a-z])([0-9])');
~~~
