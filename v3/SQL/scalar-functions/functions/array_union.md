...
| Discovery | SELECT * FROM pg_catalog.pg_proc WHERE proname = 'array_union'; |

## Purpose

Executes the scalar function array union as registered in the MonkDB scalar function registry.
