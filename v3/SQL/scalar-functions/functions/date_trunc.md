...
| Discovery | SELECT * FROM pg_catalog.pg_proc WHERE proname = 'date_trunc'; |

## Purpose

Executes the scalar function date trunc as registered in the MonkDB scalar function registry.
