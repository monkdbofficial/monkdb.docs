...
| Discovery | SELECT * FROM pg_catalog.pg_proc WHERE proname = 'extract_day_of_year'; |

## Purpose

Executes the scalar function extract day of year as registered in the MonkDB scalar function registry.

## Syntax

~~~sql
SELECT extract_day_of_year(current_timestamp);
~~~
