...
| Discovery | SELECT * FROM pg_catalog.pg_proc WHERE proname = 'modulus'; |

## Purpose

Executes the scalar function modulus as registered in the MonkDB scalar function registry.
