...
| Discovery | SELECT * FROM pg_catalog.pg_proc WHERE proname = 'current_time'; |

## Purpose

Executes the scalar function current time as registered in the MonkDB scalar function registry.
