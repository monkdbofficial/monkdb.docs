...
| Field | Value |
| --- | --- |
| Function | array_unnest |
| Category | Arrays and Collections |
| Scope | Scalar expression |
| Discovery | SELECT * FROM pg_catalog.pg_proc WHERE proname = 'array_unnest'; |

## Purpose

Executes the scalar function array unnest as registered in the MonkDB scalar function registry.
