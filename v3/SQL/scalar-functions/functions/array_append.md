...
| Discovery | SELECT * FROM pg_catalog.pg_proc WHERE proname = 'array_append'; |

## Purpose

Executes the scalar function array append as registered in the MonkDB scalar function registry.
