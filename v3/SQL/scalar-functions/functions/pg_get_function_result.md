...
| Field | Value |
| --- | --- |
| Function | pg_get_function_result |
| Category | Postgres Compatibility and System |
| Scope | Scalar expression |
| Discovery | SELECT * FROM pg_catalog.pg_proc WHERE proname = 'pg_get_function_result'; |

## Purpose

Provides PostgreSQL compatibility metadata helpers used by tools and compatibility workflows.
