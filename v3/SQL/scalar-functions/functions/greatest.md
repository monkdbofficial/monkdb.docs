...
| Discovery | SELECT * FROM pg_catalog.pg_proc WHERE proname = 'greatest'; |

## Purpose

Executes the scalar function greatest as registered in the MonkDB scalar function registry.
