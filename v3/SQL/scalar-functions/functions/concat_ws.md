...
| Discovery | SELECT * FROM pg_catalog.pg_proc WHERE proname = 'concat_ws'; |

## Purpose

Executes the scalar function concat ws as registered in the MonkDB scalar function registry.
