...
| Discovery | SELECT * FROM pg_catalog.pg_proc WHERE proname = 'array_lower'; |

## Purpose

Executes the scalar function array lower as registered in the MonkDB scalar function registry.
