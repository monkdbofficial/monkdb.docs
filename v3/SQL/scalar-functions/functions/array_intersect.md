...
| Discovery | SELECT * FROM pg_catalog.pg_proc WHERE proname = 'array_intersect'; |

## Purpose

Executes the scalar function array intersect as registered in the MonkDB scalar function registry.
