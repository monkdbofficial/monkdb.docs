...
| Discovery | SELECT * FROM pg_catalog.pg_proc WHERE proname = 'object_keys'; |

## Purpose

Executes the scalar function object keys as registered in the MonkDB scalar function registry.

## Syntax

~~~sql
SELECT object_keys({"x":1,"y":2});
~~~
