...
| Discovery | SELECT * FROM pg_catalog.pg_proc WHERE proname = 'left'; |

## Purpose

Executes the scalar function left as registered in the MonkDB scalar function registry.

## Syntax

~~~sql
SELECT left('monkdb', 3);
~~~
