...
| Discovery | SELECT * FROM pg_catalog.pg_proc WHERE proname = 'json_contains'; |

## Purpose

Executes the scalar function json contains as registered in the MonkDB scalar function registry.
