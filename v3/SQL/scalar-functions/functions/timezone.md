...
| Discovery | SELECT * FROM pg_catalog.pg_proc WHERE proname = 'timezone'; |

## Purpose

Executes the scalar function timezone as registered in the MonkDB scalar function registry.
