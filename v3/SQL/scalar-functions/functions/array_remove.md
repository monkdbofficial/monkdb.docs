...
| Discovery | SELECT * FROM pg_catalog.pg_proc WHERE proname = 'array_remove'; |

## Purpose

Executes the scalar function array remove as registered in the MonkDB scalar function registry.

## Syntax

~~~sql
SELECT array_remove([1,2,3], [2,3,4]);
~~~
