...
| Discovery | SELECT * FROM pg_catalog.pg_proc WHERE proname = 'pg_typeof'; |

## Purpose

Executes the scalar function pg typeof as registered in the MonkDB scalar function registry.
