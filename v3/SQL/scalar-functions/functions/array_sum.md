...
| Discovery | SELECT * FROM pg_catalog.pg_proc WHERE proname = 'array_sum'; |

## Purpose

Executes the scalar function array sum as registered in the MonkDB scalar function registry.
