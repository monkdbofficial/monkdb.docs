...
| Discovery | SELECT * FROM pg_catalog.pg_proc WHERE proname = 'longitude'; |

## Purpose

Executes the scalar function longitude as registered in the MonkDB scalar function registry.
