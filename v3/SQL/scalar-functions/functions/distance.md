...
| Discovery | SELECT * FROM pg_catalog.pg_proc WHERE proname = 'distance'; |

## Purpose

Executes the scalar function distance as registered in the MonkDB scalar function registry.
