...
| Discovery | SELECT * FROM pg_catalog.pg_proc WHERE proname = 'regexp_split_to_array'; |

## Purpose

Executes the scalar function regexp split to array as registered in the MonkDB scalar function registry.
