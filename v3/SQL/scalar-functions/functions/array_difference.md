...
| Discovery | SELECT * FROM pg_catalog.pg_proc WHERE proname = 'array_difference'; |

## Purpose

Executes the scalar function array difference as registered in the MonkDB scalar function registry.

## Syntax

~~~sql
SELECT array_difference([1,2,3], [2,3,4]);
~~~
