...
| Field | Value |
| --- | --- |
| Function | collection_avg |
| Category | Arrays and Collections |
| Scope | Scalar expression |
| Discovery | SELECT * FROM pg_catalog.pg_proc WHERE proname = 'collection_avg'; |

## Purpose

Executes the scalar function collection avg as registered in the MonkDB scalar function registry.

## Syntax

~~~sql
SELECT collection_avg(...);
~~~
