...
| Discovery | SELECT * FROM pg_catalog.pg_proc WHERE proname = 'date_bin'; |

## Purpose

Executes the scalar function date bin as registered in the MonkDB scalar function registry.
