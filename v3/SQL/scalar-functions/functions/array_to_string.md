...
| Discovery | SELECT * FROM pg_catalog.pg_proc WHERE proname = 'array_to_string'; |

## Purpose

Executes the scalar function array to string as registered in the MonkDB scalar function registry.
