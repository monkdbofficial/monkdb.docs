...
| Discovery | SELECT * FROM pg_catalog.pg_proc WHERE proname = 'obj_description'; |

## Purpose

Executes the scalar function obj description as registered in the MonkDB scalar function registry.
