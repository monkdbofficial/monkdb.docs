...
| Discovery | SELECT * FROM pg_catalog.pg_proc WHERE proname = 'degrees'; |

## Purpose

Executes the scalar function degrees as registered in the MonkDB scalar function registry.
