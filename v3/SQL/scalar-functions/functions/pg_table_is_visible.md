...
| Discovery | SELECT * FROM pg_catalog.pg_proc WHERE proname = 'pg_table_is_visible'; |

## Purpose

Executes the scalar function pg table is visible as registered in the MonkDB scalar function registry.
