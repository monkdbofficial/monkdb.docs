...
| Discovery | SELECT * FROM pg_catalog.pg_proc WHERE proname = 'octet_length'; |

## Purpose

Executes the scalar function octet length as registered in the MonkDB scalar function registry.
