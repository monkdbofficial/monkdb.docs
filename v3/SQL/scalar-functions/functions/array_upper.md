...
| Discovery | SELECT * FROM pg_catalog.pg_proc WHERE proname = 'array_upper'; |

## Purpose

Executes the scalar function array upper as registered in the MonkDB scalar function registry.
