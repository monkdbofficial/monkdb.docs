...
| Discovery | SELECT * FROM pg_catalog.pg_proc WHERE proname = 'array_max'; |

## Purpose

Executes the scalar function array max as registered in the MonkDB scalar function registry.
