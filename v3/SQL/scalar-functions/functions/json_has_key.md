...
| Discovery | SELECT * FROM pg_catalog.pg_proc WHERE proname = 'json_has_key'; |

## Purpose

Executes the scalar function json has key as registered in the MonkDB scalar function registry.
