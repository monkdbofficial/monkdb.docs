...
| Discovery | SELECT * FROM pg_catalog.pg_proc WHERE proname = 'array_sort'; |

## Purpose

Executes the scalar function array sort as registered in the MonkDB scalar function registry.

## Syntax

~~~sql
SELECT array_sort([1,2,3], [2,3,4]);
~~~
