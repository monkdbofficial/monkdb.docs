...
| Field | Value |
| --- | --- |
| Function | extract_century |
| Category | Date and Time |
| Scope | Scalar expression |
| Discovery | SELECT * FROM pg_catalog.pg_proc WHERE proname = 'extract_century'; |

## Purpose

Executes the scalar function extract century as registered in the MonkDB scalar function registry.

## Syntax

~~~sql
SELECT extract_century(current_timestamp);
~~~
