...
| Discovery | SELECT * FROM pg_catalog.pg_proc WHERE proname = 'substring'; |

## Purpose

Executes the scalar function substring as registered in the MonkDB scalar function registry.

## Syntax

~~~sql
SELECT substring('monkdb', 2, 3);
~~~
