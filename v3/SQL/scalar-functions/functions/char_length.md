...
| Discovery | SELECT * FROM pg_catalog.pg_proc WHERE proname = 'char_length'; |

## Purpose

Executes the scalar function char length as registered in the MonkDB scalar function registry.
