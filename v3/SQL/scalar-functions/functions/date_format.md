...
| Discovery | SELECT * FROM pg_catalog.pg_proc WHERE proname = 'date_format'; |

## Purpose

Executes the scalar function date format as registered in the MonkDB scalar function registry.
