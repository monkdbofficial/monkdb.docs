...
| Discovery | SELECT * FROM pg_catalog.pg_proc WHERE proname = 'date_sub'; |

## Purpose

Adds or subtracts interval values from date or timestamp expressions.

## Syntax

~~~sql
SELECT date_sub(current_timestamp, interval '3 hours');
~~~
