...
| Discovery | SELECT * FROM pg_catalog.pg_proc WHERE proname = 'normalize'; |

## Purpose

Performs normalization utilities for scoring and analytics pipelines.

## Syntax

~~~sql
SELECT normalize(75.0, 0.0, 100.0);
~~~
