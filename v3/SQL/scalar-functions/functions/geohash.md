...
| Discovery | SELECT * FROM pg_catalog.pg_proc WHERE proname = 'geohash'; |

## Purpose

Executes the scalar function geohash as registered in the MonkDB scalar function registry.
