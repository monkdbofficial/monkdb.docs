...
| Discovery | SELECT * FROM pg_catalog.pg_proc WHERE proname = 'regexp_replace'; |

## Purpose

Executes the scalar function regexp replace as registered in the MonkDB scalar function registry.
