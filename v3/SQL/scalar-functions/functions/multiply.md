...
| Discovery | SELECT * FROM pg_catalog.pg_proc WHERE proname = 'multiply'; |

## Purpose

Executes the scalar function multiply as registered in the MonkDB scalar function registry.

## Syntax

~~~sql
SELECT multiply(10, 3);
~~~
