...
| Discovery | SELECT * FROM pg_catalog.pg_proc WHERE proname = 'array_avg'; |

## Purpose

Executes the scalar function array avg as registered in the MonkDB scalar function registry.
