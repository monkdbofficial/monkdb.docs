...
| Discovery | SELECT * FROM pg_catalog.pg_proc WHERE proname = 'current_timestamp'; |

## Purpose

Executes the scalar function current timestamp as registered in the MonkDB scalar function registry.
