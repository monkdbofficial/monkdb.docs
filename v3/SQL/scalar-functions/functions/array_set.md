...
| Discovery | SELECT * FROM pg_catalog.pg_proc WHERE proname = 'array_set'; |

## Purpose

Executes the scalar function array set as registered in the MonkDB scalar function registry.
