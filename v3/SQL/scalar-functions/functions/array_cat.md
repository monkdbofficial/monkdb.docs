...
| Discovery | SELECT * FROM pg_catalog.pg_proc WHERE proname = 'array_cat'; |

## Purpose

Executes the scalar function array cat as registered in the MonkDB scalar function registry.
