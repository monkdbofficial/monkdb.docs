...
| Discovery | SELECT * FROM pg_catalog.pg_proc WHERE proname = 'date_part'; |

## Purpose

Executes the scalar function date part as registered in the MonkDB scalar function registry.
