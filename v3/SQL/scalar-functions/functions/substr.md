...
| Discovery | SELECT * FROM pg_catalog.pg_proc WHERE proname = 'substr'; |

## Purpose

Executes the scalar function substr as registered in the MonkDB scalar function registry.

## Syntax

~~~sql
SELECT substr('monkdb', 2, 3);
~~~
