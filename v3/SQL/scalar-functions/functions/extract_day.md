...
| Discovery | SELECT * FROM pg_catalog.pg_proc WHERE proname = 'extract_day'; |

## Purpose

Executes the scalar function extract day as registered in the MonkDB scalar function registry.

## Syntax

~~~sql
SELECT extract_day(current_timestamp);
~~~
