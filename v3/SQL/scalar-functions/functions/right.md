...
| Discovery | SELECT * FROM pg_catalog.pg_proc WHERE proname = 'right'; |

## Purpose

Executes the scalar function right as registered in the MonkDB scalar function registry.

## Syntax

~~~sql
SELECT right('monkdb', 3);
~~~
