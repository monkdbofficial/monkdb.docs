...
| Discovery | SELECT * FROM pg_catalog.pg_proc WHERE proname = 'extract_day_of_month'; |

## Purpose

Executes the scalar function extract day of month as registered in the MonkDB scalar function registry.

## Syntax

~~~sql
SELECT extract_day_of_month(current_timestamp);
~~~
