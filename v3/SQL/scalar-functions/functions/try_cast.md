...
| Discovery | SELECT * FROM pg_catalog.pg_proc WHERE proname = 'try_cast'; |

## Purpose

Executes the scalar function try cast as registered in the MonkDB scalar function registry.
