...
| Discovery | SELECT * FROM pg_catalog.pg_proc WHERE proname = 'collection_count'; |

## Purpose

Executes the scalar function collection count as registered in the MonkDB scalar function registry.
