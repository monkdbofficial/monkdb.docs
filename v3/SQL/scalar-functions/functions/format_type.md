...
| Discovery | SELECT * FROM pg_catalog.pg_proc WHERE proname = 'format_type'; |

## Purpose

Executes the scalar function format type as registered in the MonkDB scalar function registry.
