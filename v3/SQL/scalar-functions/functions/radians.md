...
| Discovery | SELECT * FROM pg_catalog.pg_proc WHERE proname = 'radians'; |

## Purpose

Executes the scalar function radians as registered in the MonkDB scalar function registry.
