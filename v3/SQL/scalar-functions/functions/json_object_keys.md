...
| Discovery | SELECT * FROM pg_catalog.pg_proc WHERE proname = 'json_object_keys'; |

## Purpose

Executes the scalar function json object keys as registered in the MonkDB scalar function registry.

## Syntax

~~~sql
SELECT json_object_keys({"x":1,"y":2});
~~~
