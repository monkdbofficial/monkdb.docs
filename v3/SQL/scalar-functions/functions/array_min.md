...
| Discovery | SELECT * FROM pg_catalog.pg_proc WHERE proname = 'array_min'; |

## Purpose

Executes the scalar function array min as registered in the MonkDB scalar function registry.
