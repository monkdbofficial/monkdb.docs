...
| Discovery | SELECT * FROM pg_catalog.pg_proc WHERE proname = 'reverse'; |

## Purpose

Executes the scalar function reverse as registered in the MonkDB scalar function registry.
