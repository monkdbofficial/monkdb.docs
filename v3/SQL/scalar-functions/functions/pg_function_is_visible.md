...
| Discovery | SELECT * FROM pg_catalog.pg_proc WHERE proname = 'pg_function_is_visible'; |

## Purpose

Executes the scalar function pg function is visible as registered in the MonkDB scalar function registry.

## Syntax

~~~sql
SELECT pg_function_is_visible(...);
~~~
