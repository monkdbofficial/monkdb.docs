...
| Discovery | SELECT * FROM pg_catalog.pg_proc WHERE proname = 'pg_backend_pid'; |

## Purpose

Executes the scalar function pg backend pid as registered in the MonkDB scalar function registry.
