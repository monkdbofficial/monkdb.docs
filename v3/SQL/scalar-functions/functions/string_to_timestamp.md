...
| Discovery | SELECT * FROM pg_catalog.pg_proc WHERE proname = 'string_to_timestamp'; |

## Purpose

Executes the scalar function string to timestamp as registered in the MonkDB scalar function registry.

## Syntax

~~~sql
SELECT string_to_timestamp('2026-03-14T10:20:30Z');
~~~
