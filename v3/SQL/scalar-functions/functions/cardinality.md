...
| Discovery | SELECT * FROM pg_catalog.pg_proc WHERE proname = 'cardinality'; |

## Purpose

Executes the scalar function cardinality as registered in the MonkDB scalar function registry.
