...
```bash
docker pull rg.fr-par.scw.cloud/monkdb/monkdb:26.3.2-amd64
```
...
```bash
docker pull rg.fr-par.scw.cloud/monkdb/monkdb:26.3.2-arm64
```

Current stable release in this guide: `26.3.2`.
...
rg.fr-par.scw.cloud/monkdb/monkdb:26.3.2-amd64   508f75ddee28        878MB             0B
```
...
```text
IMAGE                                              ID             DISK USAGE   CONTENT SIZE   EXTRA
rg.fr-par.scw.cloud/monkdb/monkdb:26.3.2-arm64   508f75ddee28        878MB             0B
```
...
docker run -d \
  ...
  --net=monkdb \
  --name=monkdb01 \
  rg.fr-par.scw.cloud/monkdb/monkdb:26.3.2-amd64 \
...
- `6000` is the HTTP endpoint for SQL-over-HTTP API clients.
